<div  x-data="{ selectedTab: $persist('userDetails') }">
    ...
    >
        ...
        <x-ui.accordion.tab-panel for="userDetails">
            <div class="w-full">
                {{-- Benutzerkonto Card --}}
                <div class="rounded-xl border border-gray-200 bg-gradient-to-b from-gray-50 to-gray-100 shadow-sm">
...
@endif
        ...
        <x-ui.accordion.tab-panel for="userRequests">
            <livewire:admin.user-profile.user-requests :user="$user" lazy />
            <livewire:admin.user-profile.request-detail-modal lazy />
        </x-ui.accordion.tab-panel>
    </x-ui.accordion.tabs>
