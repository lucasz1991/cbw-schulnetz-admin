...
class Register extends Component
{
    ...
    public function register()
    {
        ...
        $this->dispatch('showAlert', 'Registrierung erfolgreich! Bitte überprüfen Sie Ihre E-Mail, um Ihr Konto zu verifizieren. Und warten Sie auf die Freischaltung Ihres Kontos durch den Administrator.', 'success');
        session()->flash('message', 'Registrierung erfolgreich! Bitte überprüfen Sie Ihre E-Mail, um Ihr Konto zu verifizieren. Und warten Sie auf die Freischaltung Ihres Kontos durch den Administrator.');
